function ifi(){
    ...
    // const inputBox = document.querySelector('.namebox');
...
// function nameBox(event){
//   if(event.keyCode == 13 ){
//     const newp = document.createElement('p');
//     newp.classList.add('para');
//     inputBox.parentElement.replaceChild(newp,inputBox)
//     newpText = newp.innerText;
    
//     nameState.push(
//       {
//         text:event.target.value,
//         newpText:'Have a pleasent day '+ inputBox.value.charAt(0).toUpperCase() + inputBox.value.slice(1)
//       })
...
//   //   localStorage.setItem('myName',JSON.stringify(nameState))
  
//   //   }
//     }
// }
// inputBox.addEventListener('keyup',nameBox)
